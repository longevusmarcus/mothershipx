...
export default function Terms() {
  return (
    <AppLayout>
      <SEO title="Terms of Service" description="Terms of Service for MothershipX - Read our terms and conditions for using the platform." />
      ...
      <div className="max-w-3xl mx-auto py-12 px-4">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <p>
            Please read these Terms of Service ("Terms") carefully before using MothershipX ("we", "our", or "us").
            By accessing or using our website, applications, and services (collectively, the "Services"), you agree
          ...
          <section>
            ...
            <p>
              By creating an account or using any part of the Services, you acknowledge that you have read,
          ...
          <section>
            ...
            <p>
              MothershipX is a market intelligence platform that helps indie builders discover pre-validated
              market demand and participate in competitive market auditions ("Arena"). Our Services include:
            </p>
          ...
          <section>
            ...
            <p>
              You must be at least 13 years old to use our Services. If you are under 18, you represent that you
              have your parent's or legal guardian's permission to use the Services. By using the Services, you
          ...
          <section>
            ...
            <p>
              ...
              display, reproduce, and distribute your User Content in connection with the Services.
            </p>
            <p className="mt-2">
              <strong>Responsibility:</strong> You are solely responsible for your User Content and the consequences
              of posting it. You represent that you have all necessary rights to submit your User Content.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p className="mt-2">
              Payment processing is handled securely by Stripe. By making a payment, you also agree to Stripe's
              terms of service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Our Content:</strong> The Services and their original content (excluding User Content),
              features, and functionality are owned by MothershipX and are protected by copyright, trademark,
              and other intellectual property laws.
            </p>
            <p className="mt-2">
              <strong>Trademarks:</strong> "MothershipX" and our logo are trademarks. You may not use our
              trademarks without prior written consent.
            </p>
            <p className="mt-2">
              <strong>Feedback:</strong> Any feedback, suggestions, or ideas you provide about the Services
          ...
          <section>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, MOTHERSHIPX SHALL NOT BE LIABLE FOR ANY INDIRECT,
              INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS
              OF PROFITS, DATA, USE, OR GOODWILL, ARISING FROM YOUR USE OF THE SERVICES. OUR TOTAL LIABILITY
          ...
          <section>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless MothershipX and its officers, directors,
              employees, and agents from any claims, damages, losses, or expenses (including legal fees)
              arising from your use of the Services, your User Content, or your violation of these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              with or without notice. Upon termination, your right to use the Services ceases immediately.
          ...
          <section>
            ...
            <p>
              ...
              and MothershipX regarding the Services and supersede any prior agreements.
            </p>
          </section>
