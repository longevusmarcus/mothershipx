...
function TerminalTyping() {
  ...
  const terminalText = `find 1,000 startup ideas from top pain points and trends across posts on Reddit/TikTok/YouTube/whatever, build and host landing pages, register domains, wire up Stripe, test in Chrome — zero mistakes allowed
        ...
        <section className="h-screen snap-start flex flex-col items-center justify-center px-6 relative overflow-hidden">
          ...
          >
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-normal tracking-tight text-foreground leading-[1.1]">
              ...
              Build all at once.
              <br />
              <span className="text-muted-foreground">Compete to ship.</span>
              <br />
              Earn rewards from
              <br />
