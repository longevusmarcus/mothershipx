...
const mockMessages: ChatMessage[] = [
  {
    ...
    senderName: "Alex",
    senderAvatar: "A",
    content: "Hey team! Just pushed the new landing page design 🚀",
    timestamp: "10:30 AM",
  },
  {
    id: "2",
    ...
    senderAvatar: "🤖",
    content: "Great progress! Based on the problem signals, I suggest focusing on the onboarding flow next. The pain point data shows 67% of users mention confusion in the first 2 minutes.",
    timestamp: "10:32 AM",
    isAI: true,
    isPinned: true,
  },
  {
    ...
    senderName: "Sarah",
    senderAvatar: "S",
    content: "Good insight! I'll start wireframing the simplified flow",
    timestamp: "10:35 AM",
  },
  {
    id: "4",
    ...
    senderName: "Alex",
    senderAvatar: "A",
    content: "Perfect. Let's sync at 2pm? We need to ship before the sprint ends 💪",
    timestamp: "10:38 AM",
  },
];
