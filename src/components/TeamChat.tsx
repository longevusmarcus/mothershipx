...
const mockMessages: ChatMessage[] = [
  {
    ...
    senderName: "Alex",
    senderAvatar: "A",
    content: "Hey team! I've been analyzing the problem data — users are dropping off during onboarding. Anyone interested in tackling this?",
    timestamp: "10:30 AM",
  },
  {
    id: "2",
    ...
    senderAvatar: "🤖",
    content: "Great observation! The signal data shows 67% of users mention confusion in the first 2 minutes. I'd suggest a solution focused on progressive disclosure — reveal features gradually rather than all at once.",
    timestamp: "10:32 AM",
    isAI: true,
    isPinned: true,
  },
  {
    ...
    senderName: "Sarah",
    senderAvatar: "S",
    content: "I'm in! I can handle the UX flow. We need a frontend dev though — anyone know someone looking for a squad?",
    timestamp: "10:35 AM",
  },
  {
    id: "4",
    ...
    senderName: "Mike",
    senderAvatar: "M",
    content: "Count me in for frontend! React is my thing. What's our timeline looking like?",
    timestamp: "10:38 AM",
  },
  {
    id: "5",
    ...
    senderName: "Mothership AI",
    senderAvatar: "🤖",
    content: "Based on the sprint deadline and team velocity, I'd recommend: Week 1 → user research & wireframes, Week 2 → MVP build, Week 3 → testing & iteration. This positions you well for the hackathon judging.",
    timestamp: "10:40 AM",
    isAI: true,
  },
  {
    ...
    senderName: "Alex",
    senderAvatar: "A",
    content: "Perfect squad! 🔥 Let's own this problem. Sarah on UX, Mike on frontend, I'll handle product & backend. Ship it! 💪",
    timestamp: "10:42 AM",
  },
];
