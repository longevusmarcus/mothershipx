...
const features = [
  { icon: Zap, label: "Pre-validated signals (updated every week)", delay: 0 },
  { icon: Globe, label: "Full signal dashboard access", delay: 0.1 },
  ...
  { icon: FlaskConical, label: "Free ideas, landing pages & competition analysis", delay: 0.4 },
  { icon: MessageSquareText, label: "Signal-to-solution prompts (automated builder soon available)", delay: 0.5 },
                      ...
                      <div className="flex flex-col sm:items-start items-center gap-1">
                        ...
                        {SUBSCRIPTION_IS_LIFETIME && (
                          <span className="text-xs text-success font-medium mt-1">
                            Access forever • Build things that pay
                          </span>
                        )}
                      </div>
                    </motion.div>
                    ...
                    >
                      <p className="text-center sm:text-left text-xs text-muted-foreground">
                        {SUBSCRIPTION_IS_LIFETIME ? (
                          ...
                          <>
                            Cancel anytime.{" "}
                            <span className="text-foreground/80 font-medium">One win pays for 10 years.</span>
                          </>
                        )}
                      </p>
